...
Use `<relative-path>` from the workspace root (e.g., `beru-workspace/3-Resources/research/2026-04-anthropic-admin-research/findings.md`) so the user can copy and Read directly.
